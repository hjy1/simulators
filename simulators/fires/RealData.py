...
from simulators.fires.NonItTree import Tree
from simulators.Simulator import Simulator

import pickle


class RealData(Simulator):
    """
    ...
    def __init__(self, dimension, rng=None, initial_fire=None,
                 alpha=None, beta=None, tree_model='exponential', dir=""):
        """
    ...
    def _start_fire(self):
        ...
        """
        data = self.file['time_series'][self.iter]['process_state']
        self.iter+=1
        for r in range(self.dims[0]):
            for c in range(self.dims[1]):
                if data[r][c] == 1 :
